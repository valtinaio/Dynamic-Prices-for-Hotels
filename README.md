...
-> A main() function was implemented to run the complete basic pipeline for a certain data-base and future date automatically.
   A summary-result will be printed directly. Returns None though.
...
Since the model learns from old data, the hotel must have be using dynamic prices already before using this package to create enough variance within the prices.
